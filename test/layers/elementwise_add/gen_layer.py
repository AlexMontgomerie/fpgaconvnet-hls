...
import fpgaconvnet.hls.generate.layers.elementwise_add as elementwise_add

class EltWiseAddLayerTB(Layer): 
    def __init__(self):
        self.name = 'elementwise_add_layer'
    ...
    def gen_stimulus(self): 
        ...
        # data out
        assert layer.op_type == 'add', f"Operation type cannot be {layer.op_type}, must be add"
    ...
    def gen_layer(self,src_path,header_path): 
        elementwise_add.gen_elementwise_add_layer(
            self.name,
            self.param,
...
if __name__ == '__main__':
    elementwise_add_layer = EltWiseAddLayerTB()
