...
int main()
{
    ...
    // test images
    static inner_product_layer_input_t test_in[CHANNELS_3D(INNER_PRODUCT_LAYER_CHANNELS,INNER_PRODUCT_LAYER_COARSE_IN)*INNER_PRODUCT_LAYER_ROWS*INNER_PRODUCT_LAYER_COLS][INNER_PRODUCT_LAYER_COARSE_IN];
    static inner_product_layer_output_t test_out[FILTERS_PER_UNIT(INNER_PRODUCT_LAYER_FILTERS,INNER_PRODUCT_LAYER_COARSE_OUT)*rows_out*cols_out][INNER_PRODUCT_LAYER_COARSE_OUT];
